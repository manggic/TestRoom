        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-muted-foreground">Loading your tests...</p>
                </div>
            </div>
        );
    }
                        ...
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-12">
                                ...
                                <p className="text-muted-foreground text-center">
                                    There are no unattempted tests available at the moment.
                                    <br />
                                    ...
                                    <CardContent className="pt-0">
                                        <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span>Created by: {test.users?.name || "Unknown"}</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                    ...
                    {attemptedTests.length === 0 ? (
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-12">
                                ...
                                <h3 className="text-lg font-semibold mb-2">No Attempted Tests</h3>
                                <p className="text-muted-foreground text-center">
                                    You haven't attempted any tests yet.
                                    <br />
                                    Start with the unattempted tests to see your results here!
                                </p>
                            </CardContent>
                        </Card>
                    ) : (
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {attemptedTests.map((attempt) => {
                                const percentage = getScorePercentage(attempt.score_achieved || 0, attempt.tests.total_marks || 1);
                                    ...
                                    <Card key={attempt.id} className="hover:shadow-lg transition-shadow">
                                        ...
                                        <CardContent className="pt-0">
                                            <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                                                <div className="flex items-center gap-2">
                                                    <Trophy className="h-4 w-4" />
                                                    <span>Score: {attempt.score_achieved || 0}/{attempt.tests.total_marks || 0}</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span>Duration: {attempt.tests.duration_minutes || 0} min</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <User className="h-4 w-4" />
                                                    <span>Created by: {attempt.tests.users?.name || "Unknown"}</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <Calendar className="h-4 w-4" />
                                                    <span>Attempted: {formatDate(attempt.created_at)}</span>
                                                </div>
                                            </div>
                                            <Button
